...
import com.codex.purenaturefarm.fragment.FaqFragment;
import com.codex.purenaturefarm.fragment.NotificationFragment;
import com.codex.purenaturefarm.fragment.ProfileFragment;
import com.codex.purenaturefarm.fragment.ReferEarnFragment;
import com.codex.purenaturefarm.fragment.WebViewFragment;
...
import com.codex.purenaturefarm.helper.Utils;
import com.codex.purenaturefarm.ui.CircleTransform;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isUserLoggedIn()) {
            ...
            Picasso.get()
                    ...
                    .fit()
                    .centerInside()
                    .placeholder(R.drawable.pnflogo)
                    .error(R.drawable.pnflogo)
                    .transform(new CircleTransform())
                    .into(imgProfile);
        }
